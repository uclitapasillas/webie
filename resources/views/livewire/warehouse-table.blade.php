        ...
        <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
            ...
            <div class="fixed inset-0 flex items-center justify-center z-50">
                ...
                <div class="bg-white rounded-lg shadow-xl w-full max-w-lg z-10 p-6 dark:bg-gray-800">
                    <h2 class="text-lg font-semibold mb-4">Agregar Nuevo Almacén</h2>
        
                    <!-- Formulario -->
                    <form wire:submit.prevent="createAlmacen">
                        <div class="md:col-span-6 mb-4">
                            <x-label for="name">
                                Nombre de Almacén
                            </x-label>
                            <x-input id="name" wire:model="name" placeholder="Nombre del Almacén" />
                        ...
                        <div class="md:col-span-6 mb-4">
                            ...
                            <x-input id="location" wire:model="location" placeholder="Ubicación de Almacén" />
    ...
    <div class="grid grid-cols-12 gap-6">
        ...
        <div class="col-span-full xl:col-span-12 bg-white dark:bg-gray-800 shadow-sm rounded-xl">
            ...
            <header class="px-5 py-4 border-b border-gray-100 dark:border-gray-700/60 flex flex-col items-center gap-4 md:flex-row md:justify-between">
                <h2 class="font-semibold text-gray-800 dark:text-gray-100">Almacenes</h2>
                <div class="relative">
                        ...
                        <tbody class="text-sm font-medium divide-y divide-gray-100 dark:divide-gray-700/60">
                            @foreach ($almacenes as $almacen)
                                <tr>
                                    <td class="p-2">
                                        <div class="ps-1">
                                            <div class="text-base font-semibold">{{ $almacen->name }}</div>
                                            <div class="font-normal text-gray-500">{{ $almacen->location }}</div>
                                        </div>
                                    </td>
                                    <td class="p-2">
                                        <div class="text-left">{{ $almacen->created_at->diffForHumans() }}</div>
                                    </td>
