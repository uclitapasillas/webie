<x-authentication-layout>
    ...
    <div class="pt-5 mt-6 border-t border-gray-100 dark:border-gray-700/60">
        <div class="text-sm">
            {{ __('¿No tienes una cuenta?') }} <a class="font-medium text-violet-500 hover:text-violet-600 dark:hover:text-violet-400" href="{{ route('register') }}">{{ __('Registrar') }}</a>
        </div>
        <!-- Warning -->
        <div class="mt-5">
